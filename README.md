...
project needs no changes and Moa needs no restart; `moa serve --preview-port … --preview-public-url …`
only presets its port and address. It is for **your own development servers**: the previewed
app runs at the proxy's origin, and only loopback, private and tailnet addresses are
accepted. See the [Live Preview guide](docs/serve.md#live-preview).
