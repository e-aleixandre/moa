...
// EstimateOutputTokens estimates the logical output generated by an assistant
// message. It intentionally excludes thinking and counts only text and tool
// calls, which are the content returned to the user or sent to tools.
