...
const CONVERSATION = [
  { user: { kind: "short", lines: ["Put fast on the desktop status strip, after yolo."], at: "23:52", day: "ayer" } },
  { moa: TURN_A },
  { moa: TURN_A2 },
...
// The clock in the gutter (44px on the phone), mono tabular-nums, `ayer`
