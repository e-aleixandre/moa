...
import { ModelSelector, PermissionPrompt, AskUserPrompt, ResolvedAttentionReceipt, McpBanner, NotificationSettings, UsagePanel } from "../../components/index.js";
          ...
          <>
            <Stream
              ...
              tail={session.pendingAsk
                ...
                : session.resolvedPendingAttention ? <ResolvedAttentionReceipt key={session.id} session={session} /> : null}
            />
