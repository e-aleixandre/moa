...
import { parsePairing } from '../../../../../mobile/www/pairing.js';
...
test('the native app accepts the exact code generated by the web frontend', () => {
  const payload = 'moa-pair-v1:fixture-id:fixture-secret';
  const code = encodePulsePairingEnvelope('https://moa.example', payload);

  expect(parsePairing(code)).toEqual({
    origin: 'https://moa.example',
    payload,
  });
});
