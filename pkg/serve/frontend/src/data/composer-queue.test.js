...
// send-vs-enqueue gate, the recall/abort text merge, dropped-image count,
// inherited-click guard, and protection against clearing a newer draft.
import { test, expect } from 'bun:test';
import {
  willEnqueue, combineQueueText, droppedImageCount, recallActivates, sendMayClear,
...
// A stale click from a gesture that began before a recall control appeared must
// not cancel the just-queued message.
